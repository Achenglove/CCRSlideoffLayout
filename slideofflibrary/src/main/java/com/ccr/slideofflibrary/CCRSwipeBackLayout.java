 ...
 */
public class CCRSwipeBackLayout extends ViewGroup {
    ...
    private boolean isSwipeBackEnable() {
        return mSwipeBackEnable && CCRSwipeBackManager.getInstance().getPenultimateActivity() != null;
    }
    // ======================== 新加的 END ========================
    ...
    public CCRSwipeBackLayout(Context context) {
        this(context, null);
    }

    public CCRSwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CCRSwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
...
//        mOverhangSize = (int) (DEFAULT_OVERHANG_SIZE * density + 0.5f);
    ...
    void dispatchOnPanelSlide(View panel) {
        // ======================== 新加的 START ========================
        if (mIsWeChatStyle) {
            CCRSwipeBackManager.onPanelSlide(mSlideOffset);
        }
        // ======================== 新加的 END ========================
    ...
    void dispatchOnPanelClosed(View panel) {
        // ======================== 新加的 START ========================
        if (mIsWeChatStyle) {
            CCRSwipeBackManager.onPanelClosed();
        }
        // ======================== 新加的 END ========================
...
//            mDragHelper.captureChildView(mSlideableView, pointerId);
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(CCRSwipeBackLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        @Override
        public void invalidateChildRegion(CCRSwipeBackLayout parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(CCRSwipeBackLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(CCRSwipeBackLayout.class.getName());
        }
